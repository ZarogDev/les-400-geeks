          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
              <div className="flex flex-col gap-3">
                ...
                <input required type="text" className="border-b border-white/20 pb-3 bg-transparent text-white text-lg focus:outline-none focus:border-[#D4AF37] transition-colors placeholder-white/30" placeholder="Votre nom" />
              </div>
              <div className="flex flex-col gap-3">
                <label className="font-heading uppercase tracking-widest text-xs text-[#D4AF37]">Email de Contact</label>
                <input required type="email" className="border-b border-white/20 pb-3 bg-transparent text-white text-lg focus:outline-none focus:border-[#D4AF37] transition-colors placeholder-white/30" placeholder="email@exemple.com" />
              </div>
              <div className="flex flex-col gap-3">
                <label className="font-heading uppercase tracking-widest text-xs text-[#D4AF37]">Taille de l'Équipe</label>
                <select className="border-b border-white/20 pb-3 bg-transparent text-white text-lg focus:outline-none focus:border-[#D4AF37] transition-colors appearance-none cursor-pointer">
              ...
              <div className="flex flex-col gap-3">
                ...
                <input required type="date" style={{ colorScheme: "dark" }} className="border-b border-white/20 pb-3 bg-transparent text-white text-lg focus:outline-none focus:border-[#D4AF37] transition-colors cursor-pointer" />
              </div>
            </div>
            <div className="flex flex-col gap-3 mt-4">
              <label className="font-heading uppercase tracking-widest text-xs text-[#D4AF37]">Allergies ou Demandes Spéciales</label>
              <textarea className="border-b border-white/20 pb-3 bg-transparent text-white text-lg focus:outline-none focus:border-[#D4AF37] transition-colors resize-none placeholder-white/30" rows={3} placeholder="Pas de potion rouge ?"></textarea>
            </div>
            
            <div className="pt-8">
              <button type="submit" className="w-full bg-[#D4AF37] text-black hover:bg-white hover:text-black py-5 font-heading text-lg tracking-widest uppercase transition-all duration-500 shadow-[0_0_20px_rgba(212,175,55,0.3)] hover:shadow-[0_0_30px_rgba(255,255,255,0.5)]">
