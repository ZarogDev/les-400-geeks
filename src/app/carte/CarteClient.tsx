...
export default function CarteClient({ menuItems }: { menuItems: MenuItem[] }) {
  const [activeItem, setActiveItem] = useState<MenuItem | null>(menuItems[0] || null);
            ...
            {menuItems.map((item, index) => (
              ...
              >
                ...
                <div className="border-l-2 border-[#D4AF37] pl-4 py-2 mt-2">
                  <p className="font-sans italic text-sm text-black/50">{item.hint}</p>
                </div>
